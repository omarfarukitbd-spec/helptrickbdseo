...
27. **Mandatory PDF-to-Post Keyword Research & 100% Human Tone Integration Protocol (পিডিএফ বিশ্লেষণ, কিওয়ার্ড রিসার্চ ও মানবিক ইন্টিগ্রেশন প্রটোকল):**
    - পিডিএফ থেকে কোনো পোস্ট তৈরির পূর্বে এজেন্টকে প্রথমে সম্পূর্ণ পিডিএফ-এর মূল কনটেন্ট, কাঠামো ও সিলেবাস গভীরভাবে বিশ্লেষণ করতে হবে।
    - এরপর যে পোস্টটি তৈরি করা হবে, সেটির টপিক ও পাঠক চাহিদা (Search Intent) নিয়ে এজেন্টকে বিস্তারিত গবেষণা করতে হবে।
    - **বাংলা পোস্টের ক্ষেত্রে:** সংশ্লিষ্ট বিষয়ের উপর গুগলে সবচেয়ে বেশি র‍্যাঙ্ক করে এমন **বাংলা কিওয়ার্ড (Bangla Keywords)** এবং **ইংরেজি কিওয়ার্ড (English Keywords)** উভয় প্রকার কিওয়ার্ডের তালিকা আলাদাভাবে প্রস্তুত করতে হবে।
    - **ইংরেজি পোস্টের ক্ষেত্রে:** শুধুমাত্র গুগলে শীর্ষ র‍্যাঙ্কিং থাকা **ইংরেজি কিওয়ার্ডসমূহ (English Keywords Only)** গবেষণা করে তালিকা প্রস্তুত করতে হবে (কোনো বাংলা কিওয়ার্ড আসবে না)।
    - **Title, H2, H3, H4 ও Paragraph-এ ১০০% মানবিক সুরে কিওয়ার্ড সেট করা:** প্রস্তুতকৃত কিওয়ার্ডগুলোকে পোস্টের শিরোনাম, H2, H3, H4 হেডিং এবং প্রতিটি প্যারাগ্রাফের ভেতরে এমনভাবে বিন্যস্ত করতে হবে যেন প্রতিটি বাক্য অত্যন্ত প্রাসঙ্গিক (Contextually Relative) মনে হয়। কোনো কৃত্রিম বা জোরপূর্বক কিওয়ার্ড স্টাফিং করা সম্পূর্ণ নিষিদ্ধ; সম্পূর্ণ মানবিক বাকপ্রবাহ (100% Natural Human Tone & Sentence Burstiness) বজায় রেখে প্রাকৃতিকভাবে উপস্থাপন করতে হবে।
28. **Universal E-E-A-T Author Card Governance (সর্বজনীন লেখক পরিচিতি বক্স প্রটোকল):**
    - গুগল সার্চ কোয়ালিটি এবং এডসেন্স ট্রাস্টের জন্য প্রতিটি পোস্টের শেষে ফারুক স্যারের প্রামাণ্য লেখক পরিচিতি বক্স (`.htbd-author-box`) থাকা শতভাগ বাধ্যতামূলক।
    - পদবি ও বিবরণ: "শিক্ষাবিদ ও অ্যাকাডেমিক গবেষক | প্রতিষ্ঠাতা, HelpTrickBD — অ্যাকাডেমিক পাঠ্যক্রম এবং স্নাতক ও স্নাতকোত্তর পর্যায়ের রাষ্ট্রবিজ্ঞান, আধুনিক রাষ্ট্রচিন্তা ও সাহিত্য বিশ্লেষণে এক দশকের বাস্তব শিক্ষকতার অভিজ্ঞতাসম্পন্ন একজন অ্যাকাডেমিক মেন্টর।"
    - `tools/governance/pre_flight_checker.py` দ্বারা প্রতিটি পোস্টে এটি স্বয়ংক্রিয়ভাবে যাচাই করা হবে; অনুপস্থিত থাকলে পোস্ট প্রকাশ সম্পূর্ণ নিষিদ্ধ।
29. **Interactive Click-to-Reveal Accordion Architecture (ড্রপডাউন প্রশ্নোত্তর ও কুইজ ড্রপডাউন আর্কিটেকচার):**
    - মডেল টেস্ট, বহুনির্বাচনি প্রশ্ন (MCQ), বোর্ড প্রশ্ন ও সংক্ষিপ্ত প্রশ্নোত্তরের ক্ষেত্রে নেটিভ `<details><summary>` ড্রপডাউন অ্যাকর্ডিয়ন ব্যবহার করতে হবে।
    - এটি শিক্ষার্থীর সরাসরি এনগেজমেন্ট ও সাইটে অবস্থানের সময় (Dwell Time) বহুগুণ বৃদ্ধি করে যা গুগলের ১ম পেজে র‍্যাঙ্ক ধরে রাখতে অত্যন্ত কার্যকরী।
30. **Inbound Link Equity Injection Protocol (অভ্যন্তরীণ লিঙ্ক ইকুইটি ইনজেকশন):**
    - নতুন কোনো পিলার বা ক্লাস্টার পোস্ট প্রকাশের সাথে সাথে এজেন্ট সাইটের পূর্ববর্তী ১-২টি সমজাতীয় হাই-ট্রাফিক পোস্টের ভেতরে নতুন পোস্টের রেকমেন্ডেশন কার্ড বা কনটেক্সচুয়াল ইনবাউন্ড লিংক যুক্ত করে লিংক জুস ও ক্রলার প্রায়োরিটি প্রবাহিত করবে।
