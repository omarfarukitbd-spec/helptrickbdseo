...
8. **English Content Bilingual Thumbnail & Keyword Rule (ইংরেজি কনটেন্টে বাংলা ও ইংরেজি দ্বিভাষিক থাম্বনেইল ও কি-ওয়ার্ড নীতি):** পোস্ট যদি ইংরেজিতে হয় (যেমন: English 1st/2nd Paper, Grammar বা Suggestion), তবে থাম্বনেইলে **বাংলা ও ইংরেজি উভয় ভাষাই উপস্থিত থাকতে হবে** (প্রধান ইংরেজি কি-ওয়ার্ড/টাইটেল বড় হরফে এবং সাথে সাবটাইটেল/হুকে সুস্পষ্ট বাংলা টেক্সট যাতে শিক্ষার্থীদের ক্লিক-থ্রু রেট বৃদ্ধি পায়)। একইসাথে পোস্টের বডিতে, হেডিং (H1, H2), পারমালিঙ্ক ও মেটাডাটায় অবশ্যই লক্ষ্যযুক্ত **ইংরেজি কি-ওয়ার্ড (English Keywords)** যথাযথভাবে বজায় রাখতে হবে। পোস্ট বাংলায় হলে থাম্বনেইল মূলত মার্জিত বাংলায় থাকবে। **Universal English Footer Tagline:** বাংলা পোস্ট হোক বা ইংরেজি পোস্ট হোক, যেকোনো বিষয়ের থাম্বনেইল তৈরির সময় নিচের ডানপাশের ফ্রস্টেড পিল বা ফুটার ট্যাগলাইনে কখনোই বাংলা টেক্সট বসবে না; এটি সর্বদা ১০০% ইংরেজিতে থাকবে: `Learn Smart • Lead Future • Latest Edition 2026`।
