...
9. **Mandatory Byte-0 Top Placement for Blogger 8 KB Thumbnail Scanner (ব্লগারের ৮ কেবি থাম্বনেইল স্ক্যানার ও বাইট-০ রুল)**:
   - **গুগল ব্লগারের অভ্যন্তরীণ স্থাপত্য সীমাবদ্ধতা:** গুগল ব্লগারে এডমিন ড্যাশবোর্ডের পোস্ট লিস্ট, আরএসএস ফিড এবং ওপেন গ্রাফ ক্রলারের জন্য একটি পোস্টের থাম্বনেইল স্বয়ংক্রিয়ভাবে ক্যাশ করার সময় ব্যাকএন্ড ক্রলার পোস্ট এইচটিএমএলের প্রথম **৮ কিলোবাইট (৮,১৯২ বাইট)** স্ক্যান করে।
   - **সমস্যার উৎস:** যদি পোস্টের শুরুতে বড় `<style>` ট্যাগ বা সিএসএস ব্লক (যা প্রায়ই ৭,০০০–১০,০০০ ক্যারেক্টার লম্বা হয়) রাখা হয় এবং তার নিচে `<figure><img>` দেওয়া হয়, তবে ইমেজ ট্যাগটি ৮ কেবি বাফারের বাইরে (যেমন: ৯,০০০+ ক্যারেক্টারে) চলে যায়। ফলে ব্লগার স্ক্যানার ইমেজ পর্যন্ত পৌঁছানোর আগেই স্ক্যান থামিয়ে দেয় এবং পোস্টটিকে ইমেজবিহীন মনে করে এডমিন লিস্টে টাইটেলের প্রথম অক্ষরের ধূসর আইকন (যেমন: `[S]`, `[E]` ইত্যাদি) প্রদর্শন করে।
   - **বাধ্যতামূলক অলঙ্ঘনীয় নিয়ম:** প্রতিটি আর্টিকেলের এইচটিএমএল ফাইলের **সবার শীর্ষে (Byte 0 / প্রথম ১০০ ক্যারেক্টারের মধ্যে)** হিরো ব্যানারের `<figure><img ...><figcaption>...</figcaption></figure>` ট্যাগটি বসাতে হবে। এরপরে ফন্ট লিঙ্ক, `<style>` ব্লক এবং ভূমিকা প্যারাগ্রাফ ও `<!--more-->` ট্যাগ বসবে।
   - **প্রি-ফ্লাইট গেটকিফার এনফোর্সমেন্ট:** `pre_flight_checker.py` স্বয়ংক্রিয়ভাবে পরীক্ষা করবে যাতে পোস্টের প্রথম `<img>` ট্যাগটি এইচটিএমএলের প্রথম ১,০০০ ক্যারেক্টারের মধ্যে থাকে। কোনো ইমেজের ইন্ডেক্স ১,০০০ ক্যারেক্টারের বেশি হলে পাবলিশিং স্বয়ংক্রিয়ভাবে ব্লকড হবে।
