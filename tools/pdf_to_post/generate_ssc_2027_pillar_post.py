...
# -*- coding: utf-8 -*-
"""
tools/pdf_to_post/generate_ssc_2027_pillar_post.py
--------------------------------------------------
Generates the comprehensive, 100% Rule 22 and Rule 12 compliant
Pillar Post for SSC & Dakhil 2027 English 1st Paper (Subject Code: 136).
"""
...
html_content = f"""<!-- Hero Featured Banner (Rule 02: 16:9 Aspect Ratio on jsDelivr CDN) -->
<div style="text-align: center; margin: 0 0 25px 0;">
  <img src="{BANNER_CDN}" alt="এসএসসি ২০২৭ ইংরেজি ১ম পত্র চূড়ান্ত সাজেশন ও মানবণ্টন" title="এসএসসি ২০২৭ ইংরেজি ১ম পত্র সাজেশন এবং ১০০ নম্বরের পূর্ণাঙ্গ প্রস্তুতি" width="1200" height="675" loading="lazy" style="width: 100%; max-width: 100%; height: auto; border-radius: 10px; display: block; margin: 0 auto;" />
...
<!-- Position 0 Answer Box (Theme Native Class: .alert-message.alert-info) -->
...
<!-- Table of Contents (Theme Native Class: .tociki-pro) -->
<div class="tociki-pro">
  <p style="font-weight: 700; font-size: 19px; margin: 0 0 12px 0; color: #0f172a;">সূচিপত্র (Table of Contents)</p>
  <ul>
...
<h2 id="syllabus-structure">১. এসএসসি ২০২৭ ইংরেজি ১ম পত্র সিলেবাস ও ১০০ নম্বরের মানবণ্টন রূপরেখা</h2>
...
<!-- Standard Semantic Table (Theme Native SolaimanLipi Styling) -->
<table>
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="3" style="text-align: right; font-weight: 700;">সর্বমোট পূর্ণমান:</td>
      <td style="font-weight: 700;">১০০ নম্বর</td>
    </tr>
  </tbody>
</table>

<h2 id="part-a-reading">২. পার্ট-এ (রিডিং অংশ - ৭০ নম্বর) প্রশ্নভিত্তিক থ্রি-স্টার সাজেশন ও প্রস্তুতি কৌশল</h2>
...
<h3 id="seen-comprehension">প্রশ্ন ১ থেকে ৩: সিন প্যাসেজ (MCQ, প্রশ্নোত্তর ও শূন্যস্থান) (২২ নম্বর)</h3>
...
<ol>
  <li><strong>Meherjan lives in a slum on the Sirajganj Town Protection Embankment...</strong> [Unit-2, Lesson-1] (নদীভাঙন ও জলবায়ু উদ্বাস্তুদের জীবনসংগ্রাম। বিগত চট্টগ্রাম, দিনাজপুর ও যশোর বোর্ডে একাধিকবার এসেছে।)</li>
  <li><strong>Humans can neither change the sun's radiation nor the earth's orbit...</strong> [Unit-2, Lesson-3] (গ্রিনহাউস গ্যাস ও বৈশ্বিক উষ্ণায়ন সংক্রান্ত অত্যন্ত গুরুত্বপূর্ণ প্যাসেজ।)</li>
  <li><strong>May Day or International Workers' Day is observed on May 1 all over the world...</strong> [Unit-4, Lesson-2] (শ্রমিক অধিকার ও ১৮৮৬ সালের শিকাগো আন্দোলনের ঐতিহাসিক পটভূমি।)</li>
  <li><strong>21 February is a memorable day in our national history...</strong> [Unit-4, Lesson-3] (আন্তর্জাতিক মাতৃভাষা দিবস ও বায়ান্নর ভাষা আন্দোলনের আত্মত্যাগ।)</li>
  <li><strong>26 March, our Independence Day, is the biggest state festival...</strong> [Unit-4, Lesson-5] (আমাদের জাতীয় স্বাধীনতা দিবস উদযাপনের ধারাবাহিক রূপরেখা।)</li>
  <li><strong>'Heritage' is what we inherit from the past... (The Shat Gambuj Mosque)</strong> [Unit-8, Lesson-1] (ইউনেস্কো ঘোষিত বিশ্ব ঐতিহ্য বাগেরহাটের ষাট গম্বুজ মসজিদ।)</li>
  <li><strong>Eid is the main religious festival of the Muslims in Bangladesh...</strong> [Unit-12, Lesson-1] (নাড়ির টানে বাড়ি ফেরা ও গ্রামীণ শিকড়ের গুরুত্ব।)</li>
  <li><strong>Mainul Islam is a qualified farmer in Naogaon...</strong> [Unit-12, Lesson-2] (উচ্চশিক্ষিত হয়েও কৃষিকাজে অবদান রাখা ও শিকড়ের প্রতি মমত্ববোধ।)</li>
  <li><strong>Countries of the world rely heavily on petroleum, coal and natural gas...</strong> [Unit-14, Lesson-2] (নবায়নযোগ্য শক্তি ও পরিবেশবান্ধব শক্তির উৎস।)</li>
  <li><strong>The Internet technology has helped design a large number of websites...</strong> [Unit-15, Lesson-2] (সামাজিক যোগাযোগ মাধ্যম ও ভার্চুয়াল যোগাযোগের ইতিবাচক-নেতিবাচক প্রভাব।)</li>
</ol>
...
<h3 id="unseen-summary">প্রশ্ন ৪ ও ৫: আনসিন প্যাসেজ ও সামারি রাইটিং (১৫ নম্বর)</h3>
...
<h3 id="matching-table">প্রশ্ন ৬: সেন্টেন্স ম্যাচিং টেবিল (৫ নম্বর)</h3>
...
<h3 id="sentence-rearrange">প্রশ্ন ৭: রি-অ্যারেঞ্জিং সেন্টেন্সেস (৮ নম্বর)</h3>
...
<h3 id="poems-stories">প্রশ্ন ৮ ও ৯: কবিতা ও গল্প থেকে প্রশ্নোত্তর (২০ নম্বর)</h3>
...
<h2 id="part-b-writing">৩. পার্ট-বি (রাইটিং অংশ - ৩০ নম্বর) চূড়ান্ত সাজেশন</h2>
...
<h3 id="completing-story">প্রশ্ন ১০: কমপ্লিটিং স্টোরি (১৫ নম্বর)</h3>
...
<ol>
  ...
  <li><strong>Where There is a Will, There is a Way:</strong> তৃষ্ণার্ত কাক ও কলসির বুদ্ধিমত্তা।</li>
  <li><strong>A Liar Shepherd:</strong> রাখাল বালক ও বাঘের মিথ্যা উপাখ্যান।</li>
  <li><strong>Devotion to Mother:</strong> বায়েজিদ বোস্তামীর রাত জেগে মায়ের জন্য পানি নিয়ে দাঁড়িয়ে থাকা।</li>
  <li><strong>An Honest Woodcutter and Beautiful Fairy:</strong> সৎ কাঠুরের সততা ও কুড়ালের উপহার।</li>
  <li><strong>Two Friends and a Bear:</strong> বিপদের সময় স্বার্থপর বন্ধুর গাছ বেয়ে ওঠা।</li>
  <li><strong>Failure is the Pillar of Success:</strong> রবার্ট ব্রুস ও বারবার চেষ্টা করে বিজয় লাভ।</li>
  <li><strong>Dividing the Bread Between Two Cats:</strong> বানরের চালাকি ও বিড়ালদ্বয়ের রুটি ভাগাভাগি।</li>
  <li><strong>A Lion and a Grateful Mouse:</strong> সিংহ ও ক্ষুদ্র ইঁদুরের পারস্পরিক উপকারিতা।</li>
</ol>

<h3 id="dialogue-writing">প্রশ্ন ১১: ডায়ালগ রাইটিং (১৫ নম্বর)</h3>
...
<ol>
  ...
  <li><strong>Importance of Reading Newspaper:</strong> সমসাময়িক জ্ঞান বৃদ্ধির জন্য নিয়মিত খবরের কাগজ পড়ার উপকারিতা।</li>
  <li><strong>Preparation for the SSC Examination:</strong> আসন্ন বোর্ড পরীক্ষার সার্বিক প্রস্তুতি ও রিভিশন নিয়ে আলোচনা।</li>
  <li><strong>The Bad Effects of Smoking:</strong> ধূমপান ও মাদকের কুফল সম্পর্কে সচেতনতা তৈরি।</li>
  <li><strong>Benefits of Early Rising:</strong> সকালে ঘুম থেকে ওঠার শারীরিক ও মানসিক উপকারিতা।</li>
  <li><strong>Aim in Life:</strong> ভবিষ্যতে দেশ ও জাতির সেবায় আত্মনিয়োগের ভবিষ্যৎ পরিকল্পনা।</li>
  <li><strong>Importance of Physical Exercise:</strong> সুস্বাস্থ্যের জন্য প্রতিদিন ব্যায়াম করার গুরুত্ব।</li>
  <li><strong>Causes and Remedies of Road Accidents:</strong> সড়ক দুর্ঘটনার কারণ ও তা প্রতিকারের কার্যকরী উপায়।</li>
  <li><strong>Uses and Abuses of Mobile Phone:</strong> স্মার্টফোন ব্যবহারের ভালো ও মন্দ দিক।</li>
</ol>

<h2 id="gpa5-strategy">৪. এসএসসি ২০২৭ ইংরেজি ১ম পত্রে এ-প্লাস (GPA 5) নিশ্চিত করার ৫টি পরীক্ষিত কৌশল</h2>
...
<!-- Action Button (Theme Native Class: .main-button.button.sp-bt.download) -->
<div class="main-button" style="text-align: center; margin: 30px 0;">
  <a class="main-button button sp-bt download" href="https://drive.google.com/file/d/1wZfB9lE45e_EXAMPLE_SSC2027/view?usp=sharing" target="_blank" rel="noopener noreferrer">
    এসএসসি ২০২৭ ইংরেজি ১ম পত্র ফুল হ্যান্ডনোট পিডিএফ ডাউনলোড করুন
  </a>
</div>

<h2 id="related-silo">৬. এসএসসি ২০২৭ স্টাডি সিরিজের অন্যান্য গুরুত্বপূর্ণ গাইডলাইন</h2>
<!-- Series Box (Theme Native Class: .series-box) -->
<div class="series-box">
  <p style="font-weight: 700; font-size: 18px; margin: 0 0 10px 0; color: #065f46;">এসএসসি ২০২৭ ইংরেজি ১ম পত্র টপিক্যাল সাইলো ও সমাধান সিরিজ:</p>
  <ul style="margin: 0; padding-left: 20px;">
    <li><a href="https://www.helptrickbd.com/2026/09/ssc-2027-english-seen-passage-suggestion.html">পর্ব ০১: সিন প্যাসেজ সাজেশন – MCQ, প্রশ্নোত্তর ও গ্যাপ ফিলিং (প্রশ্ন ১-৩)</a></li>
    <li><a href="https://www.helptrickbd.com/2026/09/ssc-2027-english-unseen-passage-summary-writing.html">পর্ব ০২: আনসিন প্যাসেজ ইনফরমেশন ট্রান্সফার ও নির্ভুল সামারি লেখার সহজ নিয়ম (প্রশ্ন ৪-৫)</a></li>
    <li><a href="https://www.helptrickbd.com/2026/09/ssc-2027-english-matching-rearrange-rules-solution.html">পর্ব ০৩: সেন্টেন্স ম্যাচিং টেবিল ও রি-অ্যারেঞ্জ শর্টকাট টেকনিক ও ৩০টি বোর্ড সমাধান (প্রশ্ন ৬-৭)</a></li>
    <li><a href="https://www.helptrickbd.com/2026/09/ssc-2027-english-poems-stories-question-answer-guide.html">পর্ব ০৪: কবিতা ও গল্প থেকে প্রশ্নোত্তর লেখার নিয়ম ও পূর্ণাঙ্গ মডেল উত্তর (প্রশ্ন ৮-৯)</a></li>
    <li><a href="https://www.helptrickbd.com/2026/09/ssc-2027-english-completing-story-dialogue-suggestion.html">পর্ব ০৫: কমপ্লিটিং স্টোরি ও ডায়ালগ রাইটিং সেরা ১৫টি মডেল নোটস (প্রশ্ন ১০-১১)</a></li>
  </ul>
</div>

<h2 id="faqs">৭. সচরাচর জিজ্ঞাসিত প্রশ্ন (FAQ)</h2>
<div style="margin-top: 15px;">
  <p><strong>প্রশ্ন ১: এসএসসি ২০২৭ ইংরেজি ১ম পত্র পরীক্ষা কি পূর্ণ ১০০ নম্বরে হবে?</strong><br/>
  উত্তর: হ্যাঁ, শিক্ষা মন্ত্রণালয় ও শিক্ষা বোর্ডের সর্বশেষ নীতিমালা অনুযায়ী ২০২৭ সালের এসএসসি ও সমমানের পরীক্ষা পূর্ণ ১০০ নম্বরের ১০০% সিলেবাসেই অনুষ্ঠিত হবে। কোনো বিষয়ে সংক্ষিপ্ত সিলেবাস থাকবে না।</p>

  <p><strong>প্রশ্ন ২: ইংরেজি ১ম পত্রে পাস নম্বর কত?</strong><br/>
  উত্তর: ১০০ নম্বরের পরীক্ষায় পাস করতে হলে লিখিত ও রিডিং মিলিয়ে ন্যূনতম ৩৩ নম্বর পেতে হবে। তবে ভালো কলেজে ভর্তি নিশ্চিত করতে অন্তত ৮০ বা তদূর্ধ্ব নম্বর (A+) পাওয়া আবশ্যক।</p>

  <p><strong>প্রশ্ন ৩: সামারি রাইটিংয়ে পুরো ১০ নম্বর পাওয়ার উপায় কী?</strong><br/>
  উত্তর: সামারি লেখার সময় প্যাসেজের লাইন হুবহু কপি না করে মূল বক্তব্যকে নিজের ভাষায় এক-তৃতীয়াংশ (সাধারণত ৫০-৭০ শব্দে) বাক্যে উপস্থাপন করতে হবে। কোনো কোটেশন বা অতিরিক্ত উদাহরণ বর্জন করলে সর্বোচ্চ নম্বর পাওয়া যায়।</p>

  <p><strong>প্রশ্ন ৪: কমপ্লিটিং স্টোরির কি কোনো নির্দিষ্ট টাইটেল দিতে হবে?</strong><br/>
  উত্তর: হ্যাঁ, কমপ্লিটিং স্টোরি লেখার সময় একটি উপযুক্ত ও আকর্ষণীয় শিরোনাম (Title) দেওয়া বাধ্যতামূলক। শিরোনাম ছাড়া গল্প লিখলে নির্ধারিত নম্বর থেকে ১-২ নম্বর কর্তন করা হয়।</p>
</div>

<!-- Schema.org Microdata: BlogPosting & FAQPage JSON-LD -->
...
{{
  ...
  "publisher": {{
    ...
    "logo": {{
      "@type": "ImageObject",
      "url": "https://cdn.jsdelivr.net/gh/omarfarukitbd-spec/helptrickbdseo@main/assets/images/logo.png"
    }}
  }},
...
metadata = {
    "title": TITLE,
    "slug": SLUG,
    "custom_url": PERMALINK_URL,
    "url": PERMALINK_URL,
    "labels": ["SSC Suggestion", "Education", "Dakhil Suggestion"],
    "search_description": SEARCH_DESCRIPTION,
    "meta_description": SEARCH_DESCRIPTION
}
...
print(f"Generated Meta: {META_OUTPUT}")
