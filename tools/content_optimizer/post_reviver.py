...
<div class="htbd-post-wrapper">
  ...
  <div style="text-align: center; margin: 18px 0 25px 0;">
    <img src="https://cdn.jsdelivr.net/gh/omarfarukitbd-spec/helptrickbdseo@main/assets/images/posts/bangladesh-history-hero-thumbnail.jpg" 
         alt="বাংলাদেশের ইতিহাস: ১৯৪৭ থেকে ১৯৭১ মুক্তিযুদ্ধের ধারাবাহিক প্রেক্ষাপট" 
         title="বাংলাদেশের ইতিহাস: মুক্তিযুদ্ধ ও স্বাধীনতা সংগ্রাম"
    ...
    <span style="display: block; font-size: 14px; color: #5f6368; margin-top: 8px; font-style: italic;">
      চিত্র: ১৯৪৭ থেকে ১৯৭১—বাঙালির স্বাধিকার আন্দোলন ও মহান মুক্তিযুদ্ধের গৌরবোজ্জ্বল ইতিহাস
    </span>
  </div>
  ...
  <!-- Section 7 Liberation War Historical Infographic Illustration -->
  <div style="text-align: center; margin: 28px 0;">
    <img src="https://cdn.jsdelivr.net/gh/omarfarukitbd-spec/helptrickbdseo@main/assets/images/posts/1971-muktijuddho-victory-history.jpg" 
         alt="১৯৭১ সালের মহান মুক্তিযুদ্ধ ও ১৬ই ডিসেম্বরের ঐতিহাসিক বিজয়" 
         title="১৯৭১ সালের মুক্তিযুদ্ধ ও বাংলাদেশের স্বাধীনতা"
         width="1200" height="675"
         loading="lazy"
         style="width: 100%; max-width: 100%; height: auto; border-radius: 10px; box-shadow: 0 4px 14px rgba(0,0,0,0.1); display: block; margin: 0 auto;"/>
    <span style="display: block; font-size: 14px; color: #5f6368; margin-top: 8px; font-style: italic;">
      চিত্র: ১৯৭১ সালের বীর মুক্তিযোদ্ধাদের আত্মত্যাগ ও ১৬ই ডিসেম্বরের মহান বিজয়
    </span>
  </div>
