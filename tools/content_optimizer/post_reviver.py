...
def generate_bangladesh_history_article():
  ...
  <div class="htbd-link-box" style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; margin: 25px 0;">
    ...
    <ol style="margin-bottom: 0; padding-left: 25px; line-height: 2.2;">
      <li><a href="#intro" style="color: #1a73e8; text-decoration: none;">১. ভূমিকা: বাঙালি জাতীয়তাবাদের উন্মেষ</a></li>
      <li><a href="#bhasha-andolon" style="color: #1a73e8; text-decoration: none;">২. ১৯৫২ সালের ভাষা আন্দোলন ও আত্মপরিচয়ের সূচনা</a></li>
      <li><a href="#juktofront" style="color: #1a73e8; text-decoration: none;">৩. ১৯৫৪ সালের যুক্তফ্রন্ট নির্বাচন ও রাজনৈতিক মেরুকরণ</a></li>
      <li><a href="#chhoy-dofa" style="color: #1a73e8; text-decoration: none;">৪. ১৯৬৬ সালের ঐতিহাসিক ৬ দফা: বাঙালির মুক্তিসনদ</a></li>
      <li><a href="#gono-obvutthan" style="color: #1a73e8; text-decoration: none;">৫. ১৯৬৯ সালের গণঅভ্যুত্থান ও ১৯৭০-এর নির্বাচন</a></li>
      <li><a href="#timeline-table" style="color: #1a73e8; text-decoration: none;">৬. বাংলাদেশের স্বাধীনতা সংগ্রামের সালভিত্তিক তথ্য সারণী</a></li>
      <li><a href="#muktijuddho" style="color: #1a73e8; text-decoration: none;">৭. ১৯৭১ সালের মুক্তিযুদ্ধ: অপারেশন সার্চলাইট থেকে চূড়ান্ত বিজয়</a></li>
      <li><a href="#exam-prep" style="color: #1a73e8; text-decoration: none;">৮. বিসিএস ও বিশ্ববিদ্যালয়ের পরীক্ষার স্পেশাল মডেল প্রশ্নোত্তর</a></li>
      <li><a href="#faqs" style="color: #1a73e8; text-decoration: none;">৯. সচরাচর জিজ্ঞাসিত প্রশ্ন (FAQ)</a></li>
    </ol>
  </div>

  <!-- Section 1: Intro -->
  <h2 id="intro" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">১. ভূমিকা: বাঙালি জাতীয়তাবাদের উন্মেষ</h2>
  ...
  <h2 id="bhasha-andolon" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">২. ১৯৫২ সালের ভাষা আন্দোলন ও আত্মপরিচয়ের সূচনা</h2>
  ...
  <h2 id="juktofront" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">৩. ১৯৫৪ সালের যুক্তফ্রন্ট নির্বাচন ও রাজনৈতিক মেরুকরণ</h2>
  ...
  <h2 id="chhoy-dofa" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">৪. ১৯৬৬ সালের ঐতিহাসিক ৬ দফা: বাঙালির মুক্তিসনদ (Magna Carta)</h2>
  ...
  <h2 id="gono-obvutthan" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">৫. ১৯৬৯ সালের গণঅভ্যুত্থান ও ১৯৭০-এর সাধারণ নির্বাচন</h2>
  ...
  <h2 id="timeline-table" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">৬. স্বাধীনতা সংগ্রামের সালভিত্তিক ধারাবাহিক তথ্য সারণী</h2>
  ...
  <h2 id="muktijuddho" style="color: #202124; border-bottom: 2px solid #1a73e8; padding-bottom: 6px; margin-top: 35px;">৭. ১৯৭১ সালের মুক্তিযুদ্ধ: অপারেশন সার্চলাইট থেকে চূড়ান্ত বিজয়</h2>
