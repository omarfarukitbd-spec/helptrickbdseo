...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_poetry_part1.py
Publishes Poetry Part 1 to Blogger Live with 2-Step Custom Permalink Minting.
"""
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-cq-part-1.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-cq-part-1_metadata.json")

def publish_poetry_part1():
    print("=" * 75)
    print("HELPTRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST POETRY CQ PART 1")
    print("=" * 75)
    ...
    # Save manifest
    manifest_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_poetry_part1_published.json")
    ...
    print("\n" + "=" * 75)
    print(f"BANGLA 1ST POETRY PART 1 POST LIVE SUCCESSFULLY!")
    print(f"   URL: {clean_url}")
    print("=" * 75)

if __name__ == "__main__":
    publish_poetry_part1()
