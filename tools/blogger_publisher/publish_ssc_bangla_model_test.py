...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_model_test.py
Publishes 100-Mark Model Test to Blogger Live with 2-Step Custom Permalink Minting.
"""
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-model-test-question-solution-100-marks.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-model-test-question-solution-100-marks_metadata.json")

def publish_model_test():
    print("=" * 75)
    print("HELPTRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST 100-MARK MODEL TEST")
    print("=" * 75)
    ...
    # Save manifest
    manifest_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_model_test_published.json")
    ...
    print("\n" + "=" * 75)
    print(f"BANGLA 1ST 100-MARK MODEL TEST POST LIVE SUCCESSFULLY!")
