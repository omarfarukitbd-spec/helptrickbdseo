...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_poetry_part2.py
Publishes Poetry Part 2 to Blogger Live with 2-Step Custom Permalink Minting.
"""
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-cq-part-2.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-cq-part-2_metadata.json")

def publish_poetry_part2():
    print("=" * 75)
    print("HELPTRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST POETRY CQ PART 2")
    print("=" * 75)
    ...
    # Save manifest
    manifest_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_poetry_part2_published.json")
    ...
    print("\n" + "=" * 75)
    print(f"BANGLA 1ST POETRY PART 2 POST LIVE SUCCESSFULLY!")
    print(f"   URL: {clean_url}")
    print("=" * 75)

if __name__ == "__main__":
    publish_poetry_part2()
