...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_saq_bank.py
Publishes SAQ Bank to Blogger Live with 2-Step Custom Permalink Minting.
"""
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-short-question-bank-20-marks.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-short-question-bank-20-marks_metadata.json")

def publish_saq_bank():
    print("=" * 75)
    print("HELPTRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST 20-MARK SAQ BANK")
    print("=" * 75)
    ...
    # Save manifest
    manifest_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_saq_bank_published.json")
    ...
    print("\n" + "=" * 75)
    print(f"BANGLA 1ST 20-MARK SAQ BANK POST LIVE SUCCESSFULLY!")
