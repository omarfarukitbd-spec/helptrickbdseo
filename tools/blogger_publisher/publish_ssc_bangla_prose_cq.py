...
-------------------------------------------------------
Publishes Post 02 of the SSC Bangla 1st Paper Silo:
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-prose-cq-suggestions-2027.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-prose-cq-suggestions-2027_metadata.json")

def publish_prose_cq():
    print("=" * 75)
    print("HEL訊TRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST PROSE CQ")
    print("=" * 75)
    ...
    record_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_prose_cq_published.json")
    with open(record_path, "w", encoding="utf-8") as f:
        json.dump(manifest, f, ensure_ascii=False, indent=2)
    print(f"\n[OK] Deployment manifest saved to: {record_path}")

    print("\n" + "=" * 75)
    print("BANGLA 1ST PROSE CQ POST LIVE & INDEXED SUCCESSFULLY!")
