...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_poetry_mcq.py
----------------------------------------------------------
Publishes Post 02:
'এসএসসি বাংলা ১ম পত্র কবিতাংশ বহুনির্বাচনি প্রশ্নব্যাংক ২০২৬-২০২৭ (SSC Bangla 1st Paper Poetry MCQ Suggestion with Answers)'
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-mcq-question-bank-2027.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-poetry-mcq-question-bank-2027_metadata.json")

def publish_poetry_mcq():
    print("=" * 75)
    print("🚀 HELPTRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST POETRY MCQ BANK")
    print("=" * 75)
    ...
    print("\n" + "=" * 75)
    print("✅ POST 02 PUBLICATION & INDEXING COMPLETED SUCCESSFULLY!")
    print("=" * 75)
