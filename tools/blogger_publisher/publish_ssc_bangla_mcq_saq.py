...
# -*- coding: utf-8 -*-
"""
tools/blogger_publisher/publish_ssc_bangla_mcq_saq.py
------------------------------------------------------
Publishes Post 05 of the SSC Bangla 1st Paper Silo:
'SSC ও দাখিল বাংলা ১ম পত্র ৩০ নম্বরের বহুনির্বাচনি (MCQ) ও সংক্ষিপ্ত প্রশ্নব্যাংক (SAQ) ২০২৬-২০২৭'
...
HTML_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-mcq-saq-question-bank-2027.html")
META_PATH = os.path.join(PROJECT_ROOT, "output_posts", "ssc-bangla-1st-paper-mcq-saq-question-bank-2027_metadata.json")

def publish_mcq_saq():
    print("=" * 75)
    print("HEL訊TRICKBD 2-STEP PUBLISHING ENGINE — BANGLA 1ST MCQ & SAQ")
    print("=" * 75)
    ...
    record_path = os.path.join(PROJECT_ROOT, "output_posts", "ssc_bangla_mcq_saq_published.json")
    with open(record_path, "w", encoding="utf-8") as f:
        json.dump(manifest, f, ensure_ascii=False, indent=2)
    print(f"\n[OK] Deployment manifest saved to: {record_path}")

    print("\n" + "=" * 75)
    print("BANGLA 1ST MCQ & SAQ POST LIVE SUCCESSFULLY!")
